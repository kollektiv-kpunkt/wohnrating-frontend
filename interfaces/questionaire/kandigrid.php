...
$persScore = $empfehlung->score * 100;
$hue = pow($empfehlung->score, 3.5) * 120;
?>


<h2 class="fcdark">Ihr Score: <span style="color: hsl(<?= $hue ?>, 100%, 50%)"><?= $persScore ?>%</span></h2>

<p>Die Kandidat:innen aus <?= $gemeinde->gde_name ?> im Vergleich</p>
